...
def init_nuitrack():
	...
	nuitrack.set_config_value("Segmentation.Background.BackgroundMode", "static_first_frame")
...
def main():
	...
	while 1:
		...
		if img_depth.size and img_color.size:
			...
			pcd_joints.paint_uniform_color([0, 0, 0])
			...
			if first_call:
				...
				# bb = pcd_joints.get_axis_aligned_bounding_box()
				# bb.color = (1, 0, 0)
				# vis.add_geometry(bb)
				first_call = False
			else:
